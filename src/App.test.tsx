...
describe('App', () => {
  it('URLから都道府県と指標を復元し、本番形式のデータとmetadataを表示する', async () => {
    ...
    const generatedAt = screen.getByLabelText('データ生成日時')
    expect(generatedAt).toHaveTextContent('2026/07/15 21:34（JST）')
    expect(generatedAt).toHaveAttribute('dateTime', '2026-07-15T12:34:56.000Z')
